...
# ============================================================================
# 1. Controller (Standard V12 Logic)
# ============================================================================
...
# ============================================================================
# 2. ER + DAM V14 (V12 + MGDA Alpha Blend)
# ============================================================================
@register_model("er_dam_cagradV14")
class ER_DAM_CAGradV14(ContinualModel):
    NAME = "er_dam_cagradV14"
    ...
    def _solve_mgda(self, grads_new, grads_old):
        # Concatenate grads for dot product
        ...
        # Optimal alpha for: alpha * go + (1-alpha) * gn
    ...
    def observe(self, inputs, labels, not_aug_inputs, epoch=None):
        ...
        # 5. Gradient Matching & Modulation
